		...
		<div class="col-9  py-2">
			<div class="card-group">
				...
				<div class="card">
					...
					<!-- <img class="card-img-top rounded" src="resources/images/users/dt.jpg" width="250" height="260" alt="Card image cap"> -->
					<div class="card-body">
						<h5 class="card-title">Thành viên 4</h5>
						<p class="card-text">Lê Hoàng Anh</p>
						<p class="card-text">MSSV: N19DCCN005</p>
						<p class="card-text">Lớp: D19CQCN02-N</p>
					</div>
				</div>
								<div class="card">
					<!-- <img class="card-img-top rounded" src="resources/images/users/dt.jpg" width="250" height="260" alt="Card image cap"> -->
					<div class="card-body">
						<h5 class="card-title">Thành viên 5</h5>
						<p class="card-text">Võ Quang Tường</p>
						<p class="card-text">MSSV: N19DCCN185</p>
						<p class="card-text">Lớp: D19CQCN02-N</p>
					</div>
				</div>
			</div>
