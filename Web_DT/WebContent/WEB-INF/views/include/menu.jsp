...
<div class="container-wrapper fixed-top mbg-navy ">

<div class="container-wrapper navbar-wrapper navbar-expand-lg ">
	<div class="container ">
	<div class="row">
		<div class="col">
			<a style = "color:#ffffff;"class="navbar-brand mb-0 sizemenu" href="#"><i class="fas fa-phone"></i> 0366446373</a>
			<a style = "color:#ffffff;"class="navbar-brand mb-0 sizemenu" href="#"><i class="far fa-paper-plane"></i> DTT@gmail.com</a>
		</div>
		
		<div class="col-auto text-end px-0">	
			<a class="nav-link text-white" href="home/category.htm">
				<i class="fas fa-clipboard-list"></i> Danh sách thương hiệu 
...
<div class="navbar-home navbar-expand-lg container-wrapper ">
	...
	<div class="row">
	    <div class="col">
	     	<a style = "color:#ffffff;font-weight: 800;" class="navbar-brand mb-0 h1" href="#"><i class="fas fa-shopping-bag"></i> Điện thoại DTT</a>
	    </div>
	    <div class="col-8 ">
